...
public class SGuard {
    ...
    public Predicate getPredicate(Object object){
        ...
        predicate.setPredicateName("OBJ_"+object.getName()+"_STD_"+this.mades_guard.getTransition().getStateDiagram().getName()+"_TRANSITION"+this.mades_guard.getTransition().getUMLId().replace("-", "_")+"_GUARD");
        return predicate;
    }
